...
@args_doc_result
def repetitive2(string: str) -> bool:
    """
    Проверьте, повторяются ли символы в строке, второй вариант
    """
    return len(string) is not len(set(string))


@args_doc_result
def frequent_and_rare(string: str) -> tuple:
    """
    Найдите и выведите наиболее и наименее часто встречающеся слова в строке
    """
